  ...
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#07090c" },
      {
        name: "description",
        content:
          "Artist command center — growth advisor, gig pipeline, people, calendar, and real gig economics.",
      },
    ],
    links: [
      ...
      <body className="bg-bg text-fg">
        ...
        <AuthProvider>
          ...
          <Toaster
            ...
            toastOptions={{
              className:
                "bg-fg text-accent-fg border-0 font-semibold text-xs tracking-wide",
            }}
          />
        </AuthProvider>
        <Scripts />
