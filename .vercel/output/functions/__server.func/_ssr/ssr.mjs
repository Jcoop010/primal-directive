...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B3CIjrWt.mjs");
...
var manifest = { "fe5cf2d238b1d227b07f5f0cc7dfb8433122c64422ea5ba88be0d92bed669444": {
	functionName: "askGrowthAdvisor_createServerFn_handler",
	importer: () => import("./ai-CkPNf4ip.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DehgPuxk.mjs").then((n) => n.t),
